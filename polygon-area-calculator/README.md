...
* get_picture: Returns a string that represents the shape using lines of dots( * ). The number of lines should be equal to the height and the number of dots ( * ) in each line should  be equal to the width. There should be a new line special character (\n) at the end of each line. If the width or height is larger than 50, this should return the string: "Too big for picture.".
